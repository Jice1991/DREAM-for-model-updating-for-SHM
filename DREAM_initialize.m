function [chain,output,X,fx,CR,pCR,lCR,delta_tot,log_L] = DREAM_initialize(DREAMPar,Par_info,Meas_info,f_handle,chain,output,log_L);
...
[fx] = Evaluate_model(x,DREAMPar,Meas_info,f_handle);
